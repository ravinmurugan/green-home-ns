...
const provinceData: Record<string, {
  ...
  NS:  { name: "Nova Scotia",        electricRate: 0.185, oilRate: 1.55, propaneRate: 1.20, maxRebateHP: 13000, rebateNote: "⚠️ OHPA closes Jul 31, 2026 — OHPA up to $15K combined; CleanHeat up to $10K (income-qual) — efficiencyns.ca" },
  NB:  { name: "New Brunswick",      electricRate: 0.1539, oilRate: 1.52, propaneRate: 1.15, maxRebateHP: 2000,  rebateNote: "⚠️ OHPA closes Jun 30, 2026 — SaveEnergyNB up to $2K — saveenergynb.ca" },
