...
export const metadata: Metadata = {
  title: "Solar Panels in Nova Scotia — Complete Guide 2025 | GreenHomeNS",
  description:
    "NS solar guide: costs, NS Power net metering, up to $5,000 federal grant, payback period, and how to find certified installers. Updated May 2025.",
};
    ...
    <main className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 text-amber-600 text-sm font-medium mb-3">
          ...
          NS Solar Guide — Updated May 2025
        </div>
        <h1 className="text-3xl font-bold mb-3">Solar Panels in Nova Scotia</h1>
        <p className="text-gray-600 text-lg max-w-2xl leading-relaxed">
          NS Power&apos;s net metering program and up to $5,000 in federal grants make residential solar increasingly attractive — even in Nova Scotia&apos;s climate.
        </p>
      </div>

      {/* Stats */}
      <section className="bg-amber-600 rounded-2xl p-6 mb-12">
        <h2 className="font-bold text-xl mb-4 text-white">NS Solar Fast Facts</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            { stat: "1:1", label: "NS Power net metering credit rate (retail)" },
          ].map((item) => (
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">NS Power Net Metering — How It Works</h2>
        <p className="text-gray-600 mb-6 leading-relaxed">
          NS Power&apos;s net metering program credits your account at the retail electricity rate for every kWh your solar panels send back to the grid. Credits roll over monthly and are settled annually.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          {[
            { icon: Sun, title: "Generate", desc: "Your panels generate electricity from sunlight during the day." },
            { icon: Zap, title: "Use or export", desc: "Use power in your home first. Excess flows back to the NS Power grid." },
        ...
        <div className="bg-gray-100 border border-gray-200 rounded-xl p-4 text-sm text-gray-600">
          <strong>Key fact:</strong> NS Power installs a bi-directional meter at no charge. The interconnection process takes 4–8 weeks after your solar system is installed.
        </div>
      </section>

      {/* Is NS good for solar? */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">Is Nova Scotia Sunny Enough for Solar?</h2>
        <p className="text-gray-600 mb-4 leading-relaxed">
          Yes — NS receives 1,400–1,600 peak sun hours per year, comparable to parts of Germany which has one of the world&apos;s highest solar adoption rates. South-facing roofs at a 35–45° pitch perform best.
        </p>
        <ul className="space-y-2 mb-6">
          {[
            "Halifax averages 1,450 peak sun hours/year — viable for residential solar",
            "Modern panels work on cloudy days (just less efficiently)",
            "Snow load: panels shed snow quickly due to heat and angle",
            "NS electricity rates ($0.17–0.19/kWh) make solar economics strong",
          ].map((point) => (
      ...
      {/* Cost breakdown */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4">What Does Solar Cost in NS?</h2>
        ...
        <p className="text-xs text-gray-600 mt-2">Prices are estimates. Get quotes from certified NS installers for accurate pricing.</p>
      </section>

      {/* Steps */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-6">Steps to Going Solar in Nova Scotia</h2>
        <div className="space-y-4">
          {[
            ...
            { step: "2", title: "Get 3 solar quotes from NSESA-certified installers", desc: "Compare system size, brand, warranty, and NS Power interconnection experience. Use our directory." },
            { step: "3", title: "Sign and permit", desc: "Installer pulls the required electrical permit and submits your NS Power net metering application." },
            ...
            { step: "5", title: "NS Power meter swap + post-assessment", desc: "NS Power replaces your meter (bi-directional, no cost). Book post-retrofit assessment to claim the federal grant." },
          ].map((s) => (
      ...
      <div className="bg-amber-500 text-white rounded-2xl p-8 text-center">
        <h2 className="text-2xl font-bold mb-3">Get Solar Quotes from NS Installers</h2>
        <p className="text-amber-100 mb-6">Free quotes from NSESA-certified solar installers. We match you based on location and roof type.</p>
